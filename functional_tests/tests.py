...
class NewVisitorTest(LiveServerTestCase):
    ...
    def test_can_start_a_list_and_retreive_it_later(self):
        ...
        # She types "Buy peacock feathers" into a text box (Edith's hobby is tying fly
        # fishing lures)
        ...
        # site has generated a unique URL for her. There is some explanatory text to that
        # effect
